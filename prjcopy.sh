...
#cp $PROJECTDIR/myApp_perftest/*.sh $TMPDIR/perftest #perftest stuff
#cp $PROJECTDIR/myApp_perftest/config/*.sh $TMPDIR/perftest/config #perftest stuff
#cp $PROJECTDIR/myApp_perftest/config/*.any $TMPDIR/perftest/config #perftest stuff
